...
[![CI](https://github.com/yogami/aegismcp/actions/workflows/ci.yml/badge.svg)](https://github.com/yogami/aegismcp/actions/workflows/ci.yml)
...
AegisMCP wraps any stdio MCP server with **OS-level sandboxing**:
